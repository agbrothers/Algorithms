...
# Converts any image into a string of ascii characters with high resolution, fitting characters to pixels both by brightness and local shape of the image.  
# See the ASCII_OBAMA.jpg file in this repo for reference!
